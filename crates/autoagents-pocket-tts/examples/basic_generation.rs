...
//!
//! Usage:
//!   cargo run --example basic_generation --features library
//!
//! To disable audio playback:
//!   NO_PLAY=1 cargo run --example basic_generation --features library
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    save_audio_to_file(&response.audio.samples, response.audio.sample_rate, output_path)?;
