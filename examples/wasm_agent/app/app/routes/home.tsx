...
export function meta({}: Route.MetaArgs) {
  return [
    ...
    {
      name: "description",
      content: "AutoAgents with TinyLlama running in WASM",
    },
  ];
}
      ...
      <div className="relative min-h-screen flex flex-col">
        ...
        <div className="flex-1 mx-auto px-6 py-6 flex gap-6 h-full w-full">
          ...
          <div className="w-80 flex-shrink-0 h-full">
            <div className="backdrop-blur-xl bg-zinc-800/60 rounded-2xl border border-zinc-600/50 p-6 h-full">
              <div className="mb-6">
                <div className="mb-3">
              ...
              <div className="space-y-4">
                ...
                <button
                  ...
                  disabled={
                    loading || !wasmInitialized || tokenStreamer !== null
                  }
          ...
          <div className="flex-1 flex flex-col">
            ...
            {loading && (
              <div className="mb-4">
                <div className="backdrop-blur-xl bg-purple-500/25 rounded-2xl border border-purple-400/50 p-4">
                  <div className="flex items-center space-x-3">
                    <div className="flex-shrink-0">
                      <div className="w-8 h-8 relative">
                        <div className="w-8 h-8 rounded-full border-2 border-purple-500/30"></div>
                        <div className="w-8 h-8 rounded-full border-2 border-purple-500 border-t-transparent animate-spin absolute top-0"></div>
                      </div>
                    </div>
            ...
            {error && (
              <div className="mb-4">
                <div className="backdrop-blur-xl bg-red-500/25 rounded-2xl border border-red-400/50 p-4">
                  <div className="flex items-center space-x-3">
            ...
            {/* Main Chat Interface */}
            <div className="flex-1 flex flex-col">
              <div className="backdrop-blur-xl bg-zinc-800/50 rounded-2xl border border-zinc-600/50 h-full flex flex-col">
                {/* Chat Header */}
                ...
                <div className="flex-1 overflow-y-auto">
                  {chatMessages.length === 0 ? (
                    <div className="flex flex-col items-center justify-center h-full text-center p-12">
                      <div className="w-20 h-20 mb-6 rounded-2xl bg-gradient-to-br from-purple-500/20 to-pink-500/20 flex items-center justify-center backdrop-blur-xl border border-white/10">
                        <svg
                      ...
                      <p className="text-gray-400 max-w-md">
                        Your AI agent is ready to help. Start a conversation to
                        explore its capabilities.
                      </p>
                      {!tokenStreamer && (
                        <div className="mt-6 px-4 py-2 bg-amber-500/20 text-amber-300 rounded-lg text-sm">
                    ...
                    !chatMessages[chatMessages.length - 1].isStreaming && (
                      <div className="p-6">
                        <div className="flex items-start space-x-4">
                          <div className="w-10 h-10 rounded-full bg-gradient-to-r from-blue-500 to-cyan-500 text-white flex items-center justify-center">
                            <svg
                        ...
                        <textarea
                          ...
                          placeholder={
                            tokenStreamer
                              ...
                              : "Initialize an agent model first"
                          }
